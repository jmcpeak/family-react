const AUTH_BUSY = 'auth/BUSY',
  ...
  DATA_USER = 'data/USER',
  DATA_USER_CACHED = 'data/USER_CACHED',
  DATA_USERS = 'data/USERS',
  DATA_USERS_BUSY = 'data/USERS_BUSY',
  // Layout Constants
  LAYOUT_DRAWER_USERS_CLOSED = 'layout/DRAWER_CLOSED',
  LAYOUT_DRAWER_USERS_OPEN = 'layout/DRAWER_OPEN',
  LAYOUT_DRAWER_MENU_CLOSED = 'layout/DRAWER_MENU_CLOSED',
  LAYOUT_DRAWER_MENU_OPEN = 'layout/DRAWER_MENU_OPEN',
